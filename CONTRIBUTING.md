...
1. Configure the upstream repo (`git remote add upstream git://github.com/craiggwilson/gossip-net.git`)
...
1. Wait for [craiggwilson](https://github.com/craiggwilson) to merge your changes in and reformat all of your code.